...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `TASK-01` | `COMPLETE` | `TASK-12` | `NOT STARTED` | `TASK-23` | `NOT STARTED` | `TASK-34` | `NOT STARTED` |
| `TASK-02` | `COMPLETE` | `TASK-13` | `NOT STARTED` | `TASK-24` | `NOT STARTED` | `TASK-35` | `NOT STARTED` |
| `TASK-03` | `COMPLETE` | `TASK-14` | `NOT STARTED` | `TASK-25` | `NOT STARTED` | `TASK-36` | `NOT STARTED` |
| `TASK-04` | `COMPLETE` | `TASK-15` | `NOT STARTED` | `TASK-26` | `NOT STARTED` | `TASK-37` | `NOT STARTED` |
...
| `TASK-08` | `COMPLETE` | `TASK-19` | `NOT STARTED` | `TASK-30` | `NOT STARTED` | `TASK-41` | `NOT STARTED` |
| `TASK-09` | `COMPLETE` | `TASK-20` | `NOT STARTED` | `TASK-31` | `NOT STARTED` | `TASK-42` | `NOT STARTED` |
| `TASK-10` | `IN PROGRESS` | `TASK-21` | `NOT STARTED` | `TASK-32` | `NOT STARTED` | `TASK-43` | `NOT STARTED` |
