...
| Image Description and Prompt APIs are not represented, and speech-recognition scope is unverified. | API families have distinct maturity levels, inputs, and support matrices. Adding them prematurely would hide rather than teach platform constraints. | `TASK-48`, `TASK-49`, `TASK-50` |
